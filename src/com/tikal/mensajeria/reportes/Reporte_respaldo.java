package com.tikal.mensajeria.reportes;
	...
	public class Reporte_respaldo {
		...
		public HSSFWorkbook GetReporteXls(List<ReporteVo> regs) throws IOException  { //, OutputStream ops
...
//			    		        	System.out.println("prec-+"+r.getPrecio());
			    		        	System.out.println("registro:"+r);
			    		        	 ...
			    		        	 String[] datos = { r.getFecha().toString(),r.getFolio().toString(),r.getRemitente(), r.getGuia(), r.getRastreo().toString(), r.getTipoPaquete()
